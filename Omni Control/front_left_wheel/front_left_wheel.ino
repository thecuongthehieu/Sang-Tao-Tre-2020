#define encodPinA1      2    // 2 3 18 19                       // Quadrature encoder A pin
#define encodPinB1      8    // 8 9 10 11                        // Quadrature encoder B pin
                             //
#define enA             4    // 4 5 6 7                        // PWM outputs to L298N H-Bridge motor driver module
#define in1             A0    // A0 A2 A4 A6
#define in2             A1    // A1 A3 A5 A7
